...
export const KCAL_TARGET = 2000; // meta diaria estandarizada (fija, no ajustar por fases de déficit/superávit)
export const KCAL_HIGH = 2100; // a partir de aquí, "muy por encima"
